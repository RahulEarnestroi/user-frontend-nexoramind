...
import { Globe, Mail, ArrowUpRight, ChevronRight, Sparkles, Award, Shield, CheckCircle, Briefcase } from 'lucide-react';
...
export default function Footer() {
  return (
    <footer className="bg-black relative overflow-hidden">
      ...
      {/* Ambient orbs */}
      <div className="absolute bottom-0 left-[20%] w-[400px] h-[400px] rounded-full blur-[120px] bg-primary-500/5" />
      <div className="absolute bottom-0 right-[20%] w-[300px] h-[300px] rounded-full blur-[100px] bg-secondary-500/5" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 pb-12 border-b border-white/[0.06]">
          ...
          <div className="lg:col-span-5">
            ...
            <div className="flex gap-3">
              <a href="https://nexoramind.space" target="_blank" rel="noopener noreferrer"
                className="w-10 h-10 rounded-xl bg-white/[0.04] border border-white/[0.06] flex items-center justify-center text-white/40 hover:bg-primary-500/15 hover:border-primary-500/25 hover:text-primary-400 transition-all duration-300">
                <Globe className="w-4 h-4" />
              </a>
              <a href="mailto:support@nexoramind.space"
                className="w-10 h-10 rounded-xl bg-white/[0.04] border border-white/[0.06] flex items-center justify-center text-white/40 hover:bg-primary-500/15 hover:border-primary-500/25 hover:text-primary-400 transition-all duration-300">
          ...
          <div className="lg:col-span-7 lg:flex lg:items-start lg:justify-end">
            <div className="w-full max-w-md p-6 rounded-2xl bg-white/[0.03] border border-white/[0.06]">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-xs font-semibold text-primary-400 tracking-wide uppercase">Get Started</span>
              </div>
              <h3 className="text-white font-bold text-lg tracking-tight mb-2">Ready to advance your career?</h3>
              <p className="text-white/35 text-sm mb-4">Join thousands of students who have earned their certification through NexoraMind.</p>
        ...
        {/* Links grid */}
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 py-12 border-b border-white/[0.06]">
              ...
              <ul className="space-y-3">
                {section.links.map((link) => (
                  <li key={link.to}>
                    <Link
                      to={link.to}
                      className="group flex items-center gap-1 text-sm text-white/35 hover:text-primary-400 transition-colors duration-200"
                    >
                      {link.label}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8">
          ...
          <div className="flex items-center gap-5">
            ...
            <span className="flex items-center gap-1.5 text-xs text-white/20">
              <CheckCircle className="w-3 h-3" /> 986+ Certified
            </span>
          </div>
        </div>
      </div>
