    ...
    <div className="py-20 bg-black min-h-screen" style={{ fontFamily: "'Inter', system-ui, -apple-system, sans-serif" }}>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
          ...
          <p className="mt-3 text-white/40 max-w-xl mx-auto font-normal">Have questions? We'd love to hear from you.</p>
        </motion.div>
          ...
          <Card className="p-8">
            {submitted ? (
              <div className="text-center py-8">
                ...
                <p className="text-white/40 font-normal">We'll get back to you within 24 hours.</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  <label className="block text-sm font-medium text-white/60">Message</label>
                  <textarea
                    rows={5}
                    className="w-full px-4 py-2.5 bg-white/[0.04] border border-white/[0.08] rounded-xl text-sm text-white transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 placeholder:text-white/30 hover:border-white/[0.15]"
