            ...
            {!loading && certificates.length > 0 && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="flex items-center justify-center gap-6 mt-8">
                ...
                <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/[0.1] backdrop-blur-sm border border-white/[0.1]">
                  ...
                  <span className="text-sm font-bold text-emerald-300">{certificates.filter(c => c.status).length}</span>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
              {filtered.map((cert, i) => (
                <motion.div
                  ...
                  className="group relative bg-white dark:bg-white/[0.02] rounded-2xl border border-slate-200 dark:border-white/[0.06] hover:border-primary-200 dark:hover:border-primary-500/20 shadow-sm hover:shadow-lg hover:shadow-primary-500/5 transition-all duration-300 overflow-hidden flex flex-col"
                >
                  {/* Top accent */}
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-amber-500/10 to-orange-500/10 border border-amber-200/50 dark:border-amber-500/10 flex items-center justify-center group-hover:scale-105 transition-transform">
                    ...
                    {/* Title */}
                    <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-1 tracking-tight group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">{cert.roleName}</h3>
