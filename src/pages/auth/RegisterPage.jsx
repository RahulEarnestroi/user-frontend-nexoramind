...
import { Eye, EyeOff, ArrowRight, Award, FileText, Briefcase, Sparkles, Mail, User } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center border-r border-slate-200/70 dark:border-white/[0.06]"
           style={{ background: 'radial-gradient(ellipse 80% 60% at 50% 100%, rgba(139,92,246,0.10) 0%, rgba(255,255,255,0) 70%), radial-gradient(ellipse 60% 50% at 20% 20%, rgba(59,130,246,0.08) 0%, rgba(255,255,255,0) 60%), #fafbfc' }}>
        {/* Subtle grid */}
        ...
        <motion.div
          ...
          className="absolute bottom-[12%] left-[10%] w-80 h-80 rounded-full"
        ...
        <motion.div
          ...
          className="absolute top-[45%] right-[40%] w-56 h-56 rounded-full"
          style={{ background: 'radial-gradient(circle, rgba(244,114,182,0.14) 0%, rgba(244,114,182,0) 70%)', filter: 'blur(2px)' }}
        />
        ...
        <div className="relative z-10 w-full max-w-xl px-14 flex flex-col gap-10">
          ...
          >
            <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/80 dark:bg-white/[0.06] border border-slate-200/70 dark:border-white/[0.08] backdrop-blur-sm shadow-sm">
              ...
              <span className="text-[11px] font-bold text-slate-600 dark:text-white/60 tracking-wide">Free to Get Started</span>
            </div>
            <h2 className="text-4xl font-extrabold tracking-tight text-slate-900 dark:text-white leading-[1.1]">
              Create your account.
              <br />
              Unlock your <span className="bg-gradient-to-r from-primary-600 to-secondary-600 bg-clip-text text-transparent">potential</span>.
            </h2>
            <p className="text-[14px] leading-relaxed text-slate-500 dark:text-white/40 font-medium max-w-md">
              Join thousands of learners building real portfolios, earning verified certificates, and landing dream roles with structured internship programs.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                desc: 'Choose from 10+ active tech tracks & roles',
              },
              {
                icon: Award,
                ...
                desc: 'Certificates & letters as PDF + PNG downloads',
              },
              {
                icon: FileText,
                ...
                desc: 'Professional offer letter upon joining any program',
              },
            ].map((f, i) => {
              const Icon = f.icon;
              return (
                ...
                >
                  <ArrowRight className="w-4 h-4 rotate-180 text-slate-300 dark:text-white/10 group-hover:text-primary-500 dark:group-hover:text-primary-400 group-hover:-translate-x-1 transition-all duration-300 shrink-0" />
          ...
          >
            ...
            <div className="leading-tight">
              ...
              <p className="text-[10.5px] font-semibold text-slate-500 dark:text-white/35 mt-0.5">Join 10,000+ interns worldwide</p>
            </div>
          </motion.div>
        </div>
      </div>
